...
def _smallest_size_at_least(height, width, smallest_side):
  ...
  # just times 2 here, in order to keep the size still can be excat divided by 32 
  new_height = tf.to_int32(height * 2)
  new_width = tf.to_int32(width * 2)
...
def flip_gt_masks_mpii(gt_masks):
