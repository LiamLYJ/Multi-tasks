...
def _mask_encode(masks,ih,iw,stride = None,pose_dist_stride = None,num_joints = None,hp=False):
# hp generation
    ...
    for shard_id in range(num_shards):
        ...
        with tf.python_io.TFRecordWriter(record_filename) as tfrecord_writer:
            ...
            for image_id in range(start_ndx,end_ndx):
                ...
                gt_masks,dump = _mask_encode(masks,height,width,hp=True)
