...
tf.app.flags.DEFINE_integer(
    'heatmap_stride', 1,
    'how much the stride is  ')
tf.app.flags.DEFINE_integer(
    'body_stride', 30,
    'how much the stride is  ')
tf.app.flags.DEFINE_bool(
    'use_refine', True,
    'how much the pose dist stride is  ')
tf.app.flags.DEFINE_integer(
    'pos_dist_stride', 17,
    'how much the pose dist stride is  ')
tf.app.flags.DEFINE_bool(
    'use_huber',True,
    'if we use the huber loss to train the model'
    )
##########################
#                  restore
##########################
tf.app.flags.DEFINE_string(
    # 'train_dir', './output/for_testing/',
    # 'train_dir','./output/mpii_5_11',
    # 'train_dir','./output/lsp_5_21',
    'train_dir','./output/lsp_5_23',
    'Directory where checkpoints and event logs are written to.')

tf.app.flags.DEFINE_string(
    # 'pretrained_model', './data/pretrained_models/resnet_v1_50.ckpt',
    'pretrained_model', './data/pretrained_models/resnet_v1_101.ckpt',
...
tf.app.flags.DEFINE_string(
    ...
    # 'dataset_split_name','testcropped',
    # 'dataset_split_name', 'cropped_mask_rec',
    'dataset_split_name', 'lsp_train',
    'The name of the train/test/val split.')

tf.app.flags.DEFINE_string(
    # 'dataset_dir', 'data/coco/',
    # 'dataset_dir','data/mpii/',
    'dataset_dir','data/lsp/',
...
tf.app.flags.DEFINE_float(
    'adagrad_initial_accumulator_value', 0.02,
...
tf.app.flags.DEFINE_float(
    'learning_rate_decay_factor', 0.91, 'Learning rate decay factor.')
